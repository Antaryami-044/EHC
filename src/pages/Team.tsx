      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24">
          <div className="flex items-center space-x-6 mb-12">
            <h2 className="font-comfortaa text-4xl font-bold tracking-tighter uppercase text-slate-400">Mentors</h2>
              ...
              >
                <div className="flex items-center gap-5 mb-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="font-comfortaa text-ehc-indigo text-[10px] font-bold tracking-[0.2em] uppercase mt-1">{mentor.role}</p>
                  </div>
                </div>
                
                <p className="text-slate-600 text-sm leading-relaxed italic border-l-2 border-ehc-indigo/30 pl-4 font-medium">
                  "{mentor.bio}"
                </p>
              </motion.div>
            ))}
        ...
        <div className="mb-20">
          <div className="flex items-center space-x-6 mb-12">
            <h2 className="font-comfortaa text-3xl md:text-4xl font-bold tracking-tighter uppercase text-slate-400">2k23 Batch</h2>
            <div className="h-px flex-grow bg-slate-300" />
          </div>
            ...
            {batch2k23.map((member, index) => (
              ...
              >
                <div className="flex-grow pr-4">
                  ...
                  <p className="font-comfortaa text-slate-500 text-[10px] font-bold tracking-[0.15em] uppercase mt-1 leading-tight break-words">
                    {member.role}
                  </p>
                </div>
                ...
                {(member.linkedin || member.instagram) && (
                  <div className="flex-shrink-0 flex gap-2">
                    {member.linkedin && (
                      <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#0A66C2] transition-all shadow-sm">
                        <Linkedin size={16} />
                      </a>
                    )}
                    {member.instagram && (
                      <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#E1306C] transition-all shadow-sm">
                        <Instagram size={16} />
                      </a>
                    )}
                  </div>
        ...
        <div className="mb-24">
          <div className="flex items-center space-x-6 mb-12">
            <h2 className="font-comfortaa text-3xl md:text-4xl font-bold tracking-tighter uppercase text-slate-400">2k24 Batch</h2>
            <div className="h-px flex-grow bg-slate-300" />
          </div>
